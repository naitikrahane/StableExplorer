                  ...
                  {tokenTxs.map((log, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="p-4 text-right text-neon">
                          {amountFormatted}
                        </td>
                        ...
                        <td className="p-4 text-blue-400 text-xs">
                          {blockNum}
                        </td>
                        ...
                        <td className="p-4">
                          <Link
                            ...
                            className="text-neon hover:underline decoration-dashed"
                          >
